...
export const dataMovies: IDataMovies[] = [
    ...
    },
    {
        ...
        "overview": "Рассказ о появлении на свет всеми любимого снеговика Олафа, о его первых шагах, познании себя. И о цепи событий, которые приводят к судьбоносной встрече с Кристофом и Анной.",
        "popularity": 123.303,
    ...
    },
    {
        ...
        "overview": "Герцог Болтунский использует магические силы бриллианта принцессы, чтобы поднять Гавкенгбург в небо. Скай нужно будет преодолеть свои самые большие страхи и возглавить команду Улетной помощи.",
        "popularity": 123.175,
    ...
    },
    {
        ...
        "overview": "Бывший боец сопротивления, а ныне — наёмник Такэси Ковач, на планете Латимер расследует убийство босса якудза и в результате будет вынужден защищать девушку-татуировщицу, обладающую загадочной силой.",
        "popularity": 107.887,
    ...
    },
    {
        ...
        "overview": "Коко растет в джунглях под опекой Заруда-отшельника. Он знакомится с Эшем и Пикачу и узнает о мире людей, а также об опасности, которая грозит его дому.",
        "popularity": 104.934,
    ...
    },
    {
        ...
        "overview": "Инспекторы первого отдела Бюро Общественной Безопасности Арата Синдо и Кэй Михаил Игнатов продолжают расследовать деятельность таинственной организации «Биврёст» и всё ближе подбираются к раскрытию тайны загадочной смерти своих родных. Однако члены «Биврёста» не собираются останавливаться и начинают финальный раунд своей безжалостной игры. Теперь под удар попадает само Бюро, а его сотрудникам предстоит пройти через смертельные испытания. Смогут ли они остановить преступников и остаться верными своим принципам, когда на кону жизни их товарищей?",
        "popularity": 95.214,
    ...
    },
    {
        ...
        "overview": "После теракта в киевском оперном театре агент ЦРУ объединяется с британской разведкой, чтобы противостоять русскому олигарху, который сколотил состояние на торговле оружием. Для этого агенты используют инверсию времени - технологию будущего, позволяющую времени идти вспять.",
        "popularity": 86.419,
    ...
    },
    {
        ...
        "overview": "Собираясь в поездку к родителям, Джессика не могла представить, что по пути станет жертвой похищения безжалостным психопатом. Чудом высвободившись из заточения, девушка оказывается одна в дикой местности без еды и воды... с маньяком на хвосте. Её единственный шанс выжить – бежать, не оглядываясь.",
        "popularity": 85.228,
    ...
    },
    {
        ...
        "overview": "Три брата-медведя Гризли, Панда и Белый отчаянно пытаются влиться в общество людей, однако покупая еду, борясь за интернет-славу или заводя друзей, им не всегда удаётся соответствовать людской природе. Но братья всегда готовы прийти друг другу на выручку.",
        "popularity": 84.196,
    ...
    },
    {
        ...
        "overview": "Группа детей пытается спасти своих родителей-супергероев, похищенных инопланетянами. Для этого они сбегают из правительственного убежища.",
        "popularity": 83.437,
    ...
    },
    {
        ...
        "overview": "Барби открывает для себя, что значит быть современной принцессой, когда она меняется местами со своим королевским двойником.",
        "popularity": 83.245,
    ...
    },
    {
        ...
        "overview": "Жизни двух подростков, страдающих от травм прошлого, меняются, когда они находят друг друга.",
        "popularity": 81.211,
    ...
    },
    {
        ...
        "overview": "Он – профессиональный грабитель банков, который решил отойти от дел. Но стать честным, будучи вором, не так просто: ему придется дать отпор продажным копам, чтобы спасти своё имя и любимую.",
        "popularity": 80.463,
    ...
    },
    {
        ...
        "overview": "Пускай Кэндис из «Финеса и Ферба» и хочет только лучшего для своей родни, кажется, будто весь мир настроен против неё. А тут ещё и инопланетяне похитили… полоса невезения не заканчивается. Но семья так просто не бросает своих! Финес, Ферб и их друзья отправляются в опасное космическое путешествие, чтобы спасти старшую сестрёнку и победить всех инопланетян.",
        "popularity": 75.929,
    ...
    },
    {
        ...
        "overview": "Случайная встреча перевернула их привычный мир. Она — прилежная студентка и образцовая дочь, а он — дьявольски притягательный бунтарь из богатой семьи. Живя в параллельных вселенных, они бы вряд ли даже взглянули друг на друга. Однако этому знакомству суждено разделить жизнь влюбленных на до и после…",
        "popularity": 227.338,
    ...
    },
    {
        ...
        "overview": "Проходит 27 лет после первой встречи ребят с демоническим Пеннивайзом. Они уже выросли, и у каждого своя жизнь. Но неожиданно их спокойное существование нарушает странный телефонный звонок, который заставляет их вновь собраться вместе.",
        "popularity": 199.974,
    ...
    },
    {
        ...
        "overview": "Гениальный учёный работает над созданием живого оружия, используя для этого ресничку легендарного Мью. Получившееся создание он называет Мьюту. Узнав, что его планируют сделать оружием, Мьюту злится и вырывается из лаборатории. А позже начинает планировать свою месть человечеству.",
        "popularity": 176.413,
    ...
    },
    {
        ...
        "overview": "В каждом из нас живет супергерой, нужна лишь толика магии, чтобы он проявил себя. Билли Бэтсон должен прокричать всего лишь одно слово - ШАЗАМ - чтобы из сообразительного четырнадцатилетнего мальчишки превратиться во взрослого супергероя Шазама.",
        "popularity": 146.396,
    ...
    },
    {
        ...
        "overview": "Джон Уик находится в бегах. За его голову объявили награду в 14 млн. долларов, а виной всему нарушение правила — никаких убийств на территории отеля «Continental». Администратор отеля Уинстон дал всего лишь час Джону, чтобы скрыться, после чего на него начнется самая настоящая охота. Джон будет вынужден сражаться и убивать, чтобы добраться до Нью-Йорка, где он сможет найти выход из сложившейся ситуации.",
        "popularity": 128.153,
    ...
    },
    {
        ...
        "overview": "Властная руководительница крупной компании однажды просыпается обычным подростком. И теперь ей надо заново научиться управлять коллективом и провести крупную сделку, от корой зависит дальнейшая жизнь компании. Но это очень тяжело сделать, ведь тебе сейчас всего четырнадцать...",
        "popularity": 117.539,
    ...
    },
    {
        ...
        "overview": "Подчас на пути к профессиональному успеху и личному счастью реальная жизнь предлагает преодолеть трагические обстоятельства, оставляя лишь крохи надежды и веру в любовь.",
        "popularity": 72.832,
    ...
    },
    {
        ...
        "overview": "Двенадцать незнакомых между собой людей оказываются в неизвестном месте, и не понимают как туда попали. Они ещё не знают, что на них открыта охота. А они - дичь...",
        "popularity": 72.782,
    ...
    },
    {
        ...
        "overview": "В этой комедии, снятой скрытой камерой, лучших друзей ждет безумная поездка в Нью-Йорк. По дороге герои придумывают непристойные выходки и втягивают в них обычных людей.",
        "popularity": 71.815,
    ...
    },
    {
        ...
        "overview": "Новенькую старшеклассницу принимает в свою компанию группа из трёх девчонок и вскоре посвящает её в ведьмы.",
        "popularity": 68.145,
    ...
    },
    {
        ...
        "overview": "Во время поездки на выходные группа друзей вынуждена искать убежище в заброшенной тюрьме, где полвека назад работала монахиня по имени Сестра Мондэй. Ее подозревали в убийстве заключенных, но до того, как ее смогли допросить, монахиня исчезла. Во время исследования тюрьмы, герои узнают пугающую правду.",
        "popularity": 67.164,
    ...
    },
    {
        ...
        "overview": "Преступник переживает страшную трагедию и скрывается от врагов на острове Чеджу. Там он знакомится с женщиной, которая борется со своими собственными демонами.",
        "popularity": 65.835,
    ...
    },
    {
        ...
        "overview": "Выпускницы Энни, Кайла, Мишель и Стефани объединяются, чтобы заполучить желаемое и как следует оторваться напоследок.",
        "popularity": 62.843,
    ...
    },
    {
        ...
        "overview": "Чтобы вернуть крёстным феям былую популярность, молодая и неопытная волшебница решает помочь маленькой девочке, чья просьба когда-то была проигнорирована другими феями. Вот только это было очень давно, и та девочка уже успела стать взрослой женщиной, не верящей ни в какие сказки",
        "popularity": 61.082,
    ...
    },
    {
        ...
        "overview": "Банда приезжает на Хэллоуин в город, который терроризирует Джонатан Крэйнь, переодевающийся в Пугало. В городе банда помогают их старые знакомые - Эльвира и Билл Най, но желательна ли помощь этих старых знакомых или эта помощь лишь будет мешать делу?",
        "popularity": 59.212,
    ...
    },
    {
        ...
        "original_language": "ko",
        "original_title": "#살아있다",
        "overview": "Молодой человек оказывается в ловушке в жилом комплексе когда вокруг происходит прорыв зомбивирусной инфекции. Через некоторое время он замечает, что в доме напротив так же  прячется девушка.",
        "popularity": 58.585,
    ...
    },
    {
        ...
        "overview": "Выбивая черный нал из должников, два коллектора перешли дорогу главе наркокартеля, практикующему шаманство. Спровоцировав конфликт между двумя бандами, который может обернуться кровавой бойней, коллекторы поставили под угрозу жизни своих семей.",
        "popularity": 57.11,
    ...
    },
    {
        ...
        "overview": "Приходит день, когда мы должны сделать выбор. Стабильность или воплощение заветной мечты? Работа в крупной корпорации, семья или свобода творчества? Как тут не ошибиться? Фред Фитцелл оказывается во вневременном пространстве своего прошлого и будущего, где ему придется сделать выбор.",
        "popularity": 55.984,
    ...
    },
    {
        ...
        "overview": "Приехав на срочный вызов, полицейский попадает в ловушку злых духов проклятого дома.",
        "popularity": 55.75,
    ...
    },
    {
        ...
        "overview": "История о девочке, которая строит ракету, чтобы отправиться на Луну и доказать своему отцу, что легендарная богиня Луны существует.",
        "popularity": 55.528,
    ...
    },
    {
        ...
        "overview": "Наследник семьи оборотней Фредди Люпин отчаянно желает стать как предки. Но на 13-й день рождения его ждёт шок, ведь он оборачивается не волком, а… пуделем.",
        "popularity": 54.94,
    ...
    },
    {
        ...
        "overview": "Проблемная семья на грани распада сталкивается с новыми проблемами, которые заставят их усомниться друг в друге и в Боге.",
        "popularity": 54.212,
    ...
    },
    {
        ...
        "overview": "Умный пес Скуби-Ду знакомится с Шэгги, Фредом, Дафной и Вельмой. Вместе они основывают компанию Mistery Inc. Новые друзья столкнутся с проблемой – они должны разоблачить заговор, целью которого является вызов страшного призрака – пса Цербера.",
        "popularity": 54.036,
    ...
    },
    {
        ...
        "overview": "Когда в его жизнь врывается  суперсолдат с убийственной миссией, Дэдпул вынужден задуматься о дружбе, семье и о том, что на самом деле значит быть героем, попутно надирая 50 оттенков задниц. Потому что иногда чтобы делать хорошие вещи, нужно использовать грязные приемчики.",
        "popularity": 179.915,
    ...
    },
    {
        ...
        "overview": "Команда пилотируемых роботов-защитников остановила вторжение гигантских инопланетных монстров. Великая битва за Тихоокеанский рубеж ознаменовала новую главу в истории человечества. Однако война только начинается… Пришло время нового поколения отстаивать своё право на Землю.",
        "popularity": 145.071,
    ...
    },
    {
        ...
        "overview": "Бездетные супруги Пит и Элли решают усыновить ребенка, но так уж получается, что в их семье появляется сразу трое детей — две сестры и брат. Теперь Пит и Элли оказываются перед настоящим испытанием.",
        "popularity": 107.046,
    ...
    },
    {
        ...
        "overview": "После событий первой части суперсемейка пользуется повышенным вниманием со стороны журналистов. Неожиданно оказалось, что обаятельная Миссис Исключительная гораздо лучше смотрится на экране телевизора, чем её муж. Мистеру Исключительному всё чаще приходится сидеть дома и приглядывать за детьми, у каждого из которых есть свои причины быть недовольным собственными суперспособностями. Однако семейным проблемам предстоит отступить на второй план, когда окажется, что спокойствию Суперсемейки угрожает новый могущественный враг.",
        "popularity": 102.571,
    ...
    },
    {
        ...
        "overview": "Профессор палеонтологии Джонас Тэйлор, в прошлом элитный пилот глубоководных аппаратов, уже много лет пишет о меге и читает лекции, стараясь забыть незабываемое — трагически окончившуюся экспедицию, которая убедила его в том, что первобытное чудовище существует и в наши дни. При секретном погружении в самый глубокий океанский каньон Тэйлор едва спасся от огромных челюстей доисторического чудовища, способного поднять из воды даже тираннозавра. Тэйлору предлагали совершить еще более глубокое погружение. То, что он, возможно, найдет, должно заставить умолкнуть скептиков, но, когда эта находка будет поднята со дна, океанские приливы станут кроваво-красными до скончания времен.",
        "popularity": 100.814,
    ...
    },
    {
        ...
        "overview": "Фильм раскроет историю загадочного и мрачного мексиканца Алехандро Гиллике. Вместе с агентами ЦРУ он вскрывает «дыры» на границе США, которые дают путь для наркотрафика, нелегалов и даже для террористов.",
        "popularity": 89.635,
    ...
    },
    {
        ...
        "overview": "Две личинки, которые невероятно дружны между собой, по стечению обстоятельств оказываются на необитаемом острове. Любой бы на их месте испытывал истинный ужас. Но эти приятели находят в здешних безлюдных краях ни только еду и воду, но и новых друзей, представителей дикого, животного мира.",
        "popularity": 51.606,
    ...
    },
    {
        ...
        "overview": "Группа молодых людей затевает взлом дома богатой пожилой пары, однако загадочные хозяева хранят там не только сбережения, но и свои секреты.",
        "popularity": 50.116,
    ...
    },
    {
        ...
        "overview": "Ужас охватывает небольшой городок: жестоко растерзанные трупы появляются в каждую полную луну. Потрёпанный жизнью офицер Маршал берётся за расследование, даже не подозревая, что оно пошатнёт его представление о добре и зле.",
        "popularity": 49.958,
    ...
    },
    {
        ...
        "overview": "Комедийный фильм рассказывает историю режиссера, который снимает фильмы ужасов. Главный герой живёт в маленьком городке и постоянно находится в ожидании момента, когда его жизнь наконец-то изменится. И вот однажды всё же наступил долгожданный момент, у него появился реальный шанс на минуту славы, но вот только далеко не Голливуд оказался на его пороге.",
        "popularity": 49.808,
    ...
    },
    {
        ...
        "overview": "Спустя два года после победы Коула над сатанинским культом, возглавляемым его няней Би, парень пытается забыть своё прошлое и сосредоточиться на выживании в старшей школе. Но когда старые враги неожиданно вернутся, Коулу придётся снова перехитрить силы зла.",
        "popularity": 48.773,
    ...
    },
    {
        ...
        "overview": "Девушка проходит собеседование перед приёмом на работу в местном похоронном бюро, и её просят рассказать самые страшные истории. Результатом является сборник из четырёх самых страшных историй, когда-либо рассказанных за четыре десятилетия, начиная с 50-х и вплоть до 80-х годов.",
        "popularity": 47.633,
    ...
    },
    {
        ...
        "overview": "Молодые учёные из Мискатоникского университета совершают научный прорыв и изобретают машину времени. Но оказывается, что всё это время ими манипулировали невидимые силы из другого измерения.",
        "popularity": 46.049,
    ...
    },
    {
        ...
        "overview": "Отправляйтесь вместе с Джорджем и Тедом в их путешествие к ферме кузины Джинни на расслабляющие выходные на свежем воздухе. История быстро меняет своё направление, когда животные сбегают с фермы.",
        "popularity": 44.753,
    ...
    },
    {
        ...
        "overview": "После ядерной катастрофы голодающую семью под предлогом угощения завлекают для участия в спектакле в отеле, где зрители начинают исчезать.",
        "popularity": 43.719,
    ...
    },
    {
        ...
        "overview": "В прошлом она – солдат спецподразделения, в настоящем - швейцар в роскошном отеле, где готовится дерзкое ограбление. Лишь она стоит между безжалостными преступниками и бесценными произведениями искусства, спрятанными в стенах отеля.",
        "popularity": 42.773,
    ...
    },
    {
        ...
        "overview": "Даниэль переезжает в новый дом. После трагических событий он слышит мольбу о помощи от призрака и решает обратиться к знаменитому эксперту по паранормальным явлениям.",
        "popularity": 41.419,
    ...
    },
    {
        ...
        "original_language": "en",
        "original_title": "Run",
        "overview": "Гиперзаботливая мать Диана Шерман растит дочь Хлою в полной изоляции, контролируя каждый её шаг. Та прикована к инвалидному креслу, принимает множество таблеток, обучается дома и не общается со сверстниками. Разумеется, Хлоя растёт наивной девушкой, но однажды она начинает подозревать что-то неладное.",
        "popularity": 41.19,
    ...
    },
    {
        ...
        "overview": "Вернувшись из командировки, Иззи находит свой дом совершенно неузнаваемым, будто в нем поселилось какое-то жуткое зло. Обратившись за помощью, она узнает, что на ее дочерей наложено проклятье. И чтобы его снять, нужно провести новый обряд.",
        "popularity": 40.83,
    ...
    },
    {
        ...
        "overview": "Кейт выросла и стала циничным подростком, но тем не менее ей придётся объединиться с Сантой, чтобы остановить таинственного волшебника по имени Белсникель, задумавшего отобрать у человечества Рождество.",
        "popularity": 40.704,
    ...
    },
    {
        ...
        "overview": "17-летний Генри Пейдж - самопровозглашённый романтик, который еще никогда не влюблялся. Он ждёт свою единственную, а пока всё свободное время посвящает школьной газете. Однажды в школе появляется новенькая Грейс Таун, и Генри понимает, что в скором будущем его жизнь изменится навсегда.",
        "popularity": 39.883,
    ...
    },
    {
        ...
        "overview": "Рассказ о каждодневной жизни участниц южнокорейской поп-группы Blackpink и их выступлении на музыкальном фестивале Coachella в 2019 году.",
        "popularity": 39.078,
    ...
    },
    {
        ...
        "overview": "В самом фешенебельном пригороде Буэнос-Айреса пятеро грабителей ворвались в здание банка Рио де Акассусо. Взяв в заложники всех сотрудников и посетителей банка, они начали переговоры с прибывшей полицией. Пока сотни полицейских окружали здание, благодаря хитроумному плану и тщательной подготовке преступникам удалось вынести из хранилища деньги и ценности на общую сумму в более чем 15 миллионов долларов.",
        "popularity": 38.177,
    ...
    },
    {
        ...
        "overview": "Лара Джин и Питер – пара, а значит, все у них отлично, не правда ли? Но в жизни девушки снова появляется давний возмутитель спокойствия, и просыпаются старые чувства.",
        "popularity": 37.485,
    ...
    },
    {
        ...
        "overview": "После убийства местной спортивной звезды в Университете Уайтон раскрываются невероятные подробности жизни студентов, их секреты и тайные способы коммуникации. Один из них — комментарии, состоящие из одного лишь восклицательного знака, подтекст которого окажется намного страшнее, чем кажется.",
        "popularity": 36.173,
    ...
    },
    {
        ...
        "overview": "Школьнику Дэнни живется несладко: он не может подружиться с одноклассниками и не находит общего языка с преподавателями. И всему виной его гениальность. Но однажды он попадает в школу для одаренных детей, где случайно открывает портал в мир монстров.",
        "popularity": 35.904,
    ...
    },
    {
        ...
        "overview": "Известная писательница Вероника Хенли оказывается в ловушке ужасающей реальности и должна раскрыть безумную тайну, пока не стало слишком поздно.",
        "popularity": 35.675,
    ...
    },
    {
        ...
        "overview": "Когда первокурсница средней школы Келли Фергюсон неохотно соглашается посидеть с ребенком на Хэллоуин, ее вербуют в тайное общество нянь, которые защищают от монстров детей с особыми способностями.",
        "popularity": 35.196,
    ...
    },
    {
        ...
        "overview": "Когда бывший коллега Джона решает взять под свой контроль таинственную гильдию убийц, Уик вынужден выйти из отставки. Ведомый кровавой клятвой Джон отправляется в Рим, где ему придется сразиться с одними из самых опасных киллеров в мире.",
        "popularity": 128.568,
    ...
    },
    {
        ...
        "overview": "Пока Кристиан Грей борется со своими внутренними демонами, Анастейша Стил вынуждена противостоять гневу и зависти тех женщин, что были с Кристианом до нее.",
        "popularity": 127.437,
    ...
    },
    {
        ...
        "overview": "Эш собирается посетить лабораторию профессора Оука, чтобы получить своего первого покемона. Но профессор спешит сообщить, что три стартовых покемона — Бульбазавр, Сквиртл и Чармандер — уже были выбраны другими тренерами, которые пришли раньше. Профессор предлагает Эшу оставшегося покемона электрического типа — Пикачу. Из-за упрямого характера Пикачу отказывается быть внутри покебола, но Эш с радостью принимает его и отправляется в далёкое путешествие.",
        "popularity": 126.893,
    ...
    },
    {
        ...
        "overview": "Встречайте самого знаменитого гонщика всех времен, легенду гоночного трека Молнию Маккуина! Герой все еще продолжает показывать лучшие результаты на всех турнирах, однако победы даются ему не так легко, а конкуренция становится все жестче. Молнию Маккуина ждут захватывающие приключения, где он встретит новых друзей, а также поймет, что не только скорость и мощность мотора делают гонщика чемпионом.",
        "popularity": 123.822,
    ...
    },
    {
        ...
        "overview": "Мистические события происходят в судьбе главного героя, переживающего трагедию. Он получает личное приглашение встретиться с самим Всевышним в очень уединенном месте…",
        "popularity": 123.524,
    ...
    },
    {
        ...
        "overview": "Вдохновившись самопожертвованием Супермена, Брюс Уэйн вновь обретает веру в человечество. Он заручается поддержкой новой союзницы Дианы Принс, чтобы сразиться с ещё более могущественным противником. Бэтмен и Чудо-Женщина быстро набирают команду сверхлюдей для борьбы с пробудившейся угрозой. Но, несмотря на уникальный состав отряда супергероев — Бэтмен, Чудо-Женщина, Аквамен, Киборг и Флэш, — быть может, спасать планету от вторжения катастрофических масштабов уже слишком поздно.",
        "popularity": 102.037,
    ...
    },
    {
        ...
        "overview": "Керри Болдуин выходит из тюрьмы досрочно с условием отработки оставшейся части срока в железнодорожном депо. Но её главная цель - найти младшую сестру, которая недавно вышла на таких же условиях и пропала без вести.",
        "popularity": 34.149,
    ...
    },
    {
        ...
        "overview": "После ухода жены, писатель Джейк вместе со своей дочерью-инвалидом Дэни решают провести Хэллоуин в печально известном доме с приведениями. Мужчина надеется, что в этот вечер к нему наконец придет вдохновение написать ту самую историю ужасов, но вскоре осознает, что оказался заложником своего же сценария.",
        "popularity": 32.999,
    ...
    },
    {
        ...
        "overview": "В результате странного инцидента старшеклассница оказывается в теле жестокого серийного убийцы. У неё есть меньше 24 часов, чтобы всё исправить, после чего ситуацию будет уже не обратить.",
        "popularity": 32.957,
    ...
    },
    {
        ...
        "overview": "Известный писатель в компании дочери переезжает в удаленный замок для написания очередного шедевра в жанре ужасов. Он выбрал для этого очень подходящее, но очень опасное место, ведь в стенах постройки затаилось древнейшее зло.",
        "popularity": 32.808,
    ...
    },
    {
        ...
        "original_language": "en",
        "original_title": "Heks",
        "overview": "Скорбящая молодая девушка возвращается из Англии в родную Южно-Африканскую глубинку, чтобы пролить свет на убийство своей матери, которое может быть как-то связано с держащей в страхе всю округу знахаркой.",
        "popularity": 32.188,
    ...
    },
    {
        ...
        "overview": "Недавно ослепшая Ребекка, ее парень Джон и их друзья едут в Албанию, чтобы управлять неожиданно доставшимся в наследство Ребекке замком от ее давно потерянной матери. Прибыв на место, они узнают, что у семьи Ребекки были мрачные тайны, последствия которых могут быть колоссальными.",
        "popularity": 31.975,
    ...
    },
    {
        ...
        "overview": "Брат с сестрой Люк и Мими невольно воскрешают древнего военачальника инопланетных пришельцев. Используя волшебный амулет, они заставляют монстра повиноваться своим детским прихотям и случайно вызывают целую армию межгалактических убийц в родной городок.",
        "popularity": 31.761,
    ...
    },
    {
        ...
        "overview": "Группа американских парапсихологов едет в Уэльс, чтобы провести исследование замка Маргам, одного из самых густонаселенных призраками зданий в Великобритании.",
        "popularity": 30.963,
    ...
    },
    {
        ...
        "overview": "Как это принято в некоторых районах Индии, мальчик и девочка были помолвлены, но парень не спешил жениться, вырос и уехал. А вернувшись в родные края, обнаружил, что там свирепствует злобный ночной демон, убивающий только мужчин. Местные считают, что его суженая обернулась мифической сущностью и таким кровожадным способом скорбит о своей потере.",
        "popularity": 30.829,
    ...
    },
    {
        ...
        "overview": "Когда Мэгги влюбляется в маленького мальчика, Мардж устраивает ей свидание в лучшем игровом парке для малышей Спрингфилда.",
        "popularity": 30.547,
    ...
    },
    {
        ...
        "overview": "Семейная пара Лиза и Шон вместе с маленьким сыном Джудом переезжает в большой дом, не подозревая о его страшном прошлом. Подозрения возникают, когда Джуд заводит дружбу с необычной фарфоровой куклой по имени Брамс, которая слишком похожа на живую.",
        "popularity": 30.54,
    ...
    },
    {
        ...
        "overview": "Курт Канкл - водитель, работающий в каршеринге - ведет собственный блог. В погоне за популярностью и увеличению числа подписчиков своего канала устраивает стримы, на которых подвергает своих клиентов смертельной опасности.",
        "popularity": 30.011,
    ...
    },
    {
        ...
        "overview": "Чирлидер Эддисон и зомби-футболист Зед готовятся к школьному выпускному балу. Однако, когда неожиданно прибыла группа загадочных подростков-оборотней, испуганный городской совет пересматривает законы против монстров Сибрука, делая невозможным участие Зеда и Эддисон в выпускном вечере.",
        "popularity": 29.792,
    ...
    },
    {
        ...
        "overview": "Команда ученых на подводной исследовательской станции переживает землетрясение и сталкивается с неведомым океанским ужасом.",
        "popularity": 28.846,
    ...
    },
    {
        ...
        "overview": "Во время нападения на человечество ужасных монстров у Джоэла погибли родители. Выжившие теперь прячутся от новых хозяев планеты под землей, но парень не оставляет надежды найти свою девушку. И вот, однажды поймав её сигнал по радио, он отправляется на поиски любви всей своей жизни и встречает других выживальщиков.",
        "popularity": 28.636,
    ...
    },
    {
        ...
        "overview": "Находясь в гостях у матери своего жениха на юге Италии, женщина должна бороться с таинственным и злобным проклятием, направленным на то, чтобы забрать ее дочь.",
        "popularity": 28.338,
    ...
    },
    {
        ...
        "overview": "Образцовая католичка Элис внезапно открыла для себя чувственный мир самоудовлетворения, и теперь боится угодить прямиком в ад. В поисках искупления девушка отправляется в весьма сомнительный религиозный лагерь-лечебницу, но там сдерживать низменные позывы оказывается ещё сложнее.",
        "popularity": 27.941,
    ...
    },
    {
        ...
        "overview": "Бывшему военному с посттравматическим синдромом по имени Томас некуда податься, поэтому приходится бомжевать в Лондоне. Однажды он получает предложение пожить в отдалённом особняке в компании молодой женщины и её смертельно больной матери. Томас помогает с ремонтом дома, постепенно влюбляется в молодую хозяйку, и ему всё больше кажется, что тут творится что-то зловещее, кроме того, мужчина теряет ощущение реальности.",
        "popularity": 27.48,
    ...
    },
    {
        ...
        "overview": "Действия фильма разворачиваются в начале супергеройской карьеры Кларка Кента, который недавно устроился репортёром в Daily Planet. По сюжету на Землю нападают Лобо и Паразит, с которыми предстоит сразиться Супермену и Марсианскому Охотнику.",
        "popularity": 27.307,
    ...
    },
    {
        ...
        "overview": "Думаешь, у тебя есть все что нужно чтобы быть боссом? Этот интерактивный спэшл проверяет ваши управленческие навыки и подбирает для вас одну из 16 вакансий в Бэби Корп.",
        "popularity": 27.121,
    ...
    },
    {
        ...
        "overview": "Педро решил завязать с наркобизнесом и, опасаясь за жизнь семьи, оборудовал свой дом как неприступную крепость. Однажды вечером на периметре срабатывает сигнализация, после чего охранники обнаруживают нарушительницу — с виду безобидную босую девочку. А вскоре за ней является отряд хорошо подготовленных убийц с мечами и арбалетами и, убив всю охрану, начинает осаждать успевшего закрыть дом бронёй Педро и его близких. У ассасинов всего одно требование — выдать им девочку, но Педро решает её защищать.",
        "popularity": 26.707,
    ...
    },
    {
        ...
        "overview": "Инопланетяне пытаются украсть гравитацию Земли, и только дух Рождества и маленький инопланетянин по имени Икс могут спасти мир.",
        "popularity": 26.369,
    ...
    },
    {
        ...
        "overview": "Со Юн — талантливый кондитер, но из-за болезни матери ей приходится работать в кофейне Сын Дже — несдержанного и грубого боса. Однажды она угощает незнакомую старушку, промокшую под дождем, и та в благодарность дарит ей книгу, обложка которой гласит, что в ней можно найти ответы на все вопросы о любви. И когда предсказания книги начинают сбываться одно за другим, девушка уже сложно не прислушиваться к ее советам.",
        "popularity": 26.305,
    ...
    },
    {
        ...
        "overview": "В спецвыпуске Рей, Финн, По, Чуи, Роуз и дроиды воссоединятся на экране для празднования Дня жизни. Чтобы лучше познать силу, Рей вместе с BB-8 прилетает в таинственный храм джедаев, откуда с помощью загадочного артефакта отправляется в приключение по любимым моментам франшизы. Она встретится с Люком Скайуокером, Дартом Вейдером, Йодой, Оби-Ваном и другими знаковыми героями и злодеями.",
        "popularity": 26.304,
    ...
    },
    {
        ...
        "overview": "Решительная Анджела загадывает желание воссоединить свою семью к Рождеству, а затем запускает план, как найти дорогу из Ирландии в Австралию.",
        "popularity": 26.06,
    ...
    },
    {
        ...
        "overview": "Тео Конрой - обеспеченный бывший банкир на пенсии, чей брак с намного более молодой женой-актрисой, Сюзанной, трещит по швам из-за его ревности и мрачных теней в его прошлом. Стремясь наладить отношения, Тео и Сюзанна отправляются вместе с шестилетней дочкой Эллой отдохнуть в съемном загородном доме в Уэльсе. Однако вскоре после приезда Тео начинает подозревать, что некая зловещая сила в доме знает их с Сюзанной секреты даже лучше, чем они сами знают друг друга.",
        "popularity": 25.5,
    ...
    },
    {
        ...
        "overview": "Две сестры вместе с отцом переезжают из города в деревню, пожить к бабушке. На её ферме они обнаруживают маленького единорога по имени Рокко, с которым заводят дружбу. Рокко обладает магическими силами и дарит девочкам немного счастья, шуток и смеха, что облегчает приспособление к новому дому и школе. Но когда местные нищие ковбои узнают о волшебном единороге, они похищают Рокко, чтобы использовать его силы для себя. Сёстры отправляются спасать своего друга.",
        "popularity": 25.194,
    ...
    },
    {
        ...
        "overview": "Через 15 лет после трагических событий, которые перевернули его жизнь, Кори, уже взрослый, но ещё не оправившийся от детской травмы юноша, едет на встречу выпускников. Однако, его планам хорошо провести время с друзьями и сблизиться с симпатичной бывшей однокурсницей снова мешает Зубная фея.",
        "popularity": 24.96,
